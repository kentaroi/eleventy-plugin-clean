...
const unlock = function() {
  isLocked = false;
  updateReservedFileRecords();
};

const updateReservedFileRecords = function() {
  for (let [outputPath, inputPath] of reservedFiles) {
    updateFileRecord(outputPath, inputPath);
  }
  reservedFileRecords = [];
};

const updateFileRecordWithLock = function(outputPath, inputPath) {
  if (isLocked) {
    reservedFiles.push([outputPath, inputPath]);
    return;
  }
...
const plugin = {
  ...
  updateFileRecord: updateFileRecordWithLock,
